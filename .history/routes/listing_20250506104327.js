...
router.route("/:id").get(wrapAsync(ListingController.showRoute)).put(isLoggedIn,isOwner,upload.single("listing") wrapAsync(ListingController.update)).delete(isOwner, ListingController.deleteRoute);
