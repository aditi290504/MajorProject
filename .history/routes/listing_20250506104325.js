...
router.route("/:id").get(wrapAsync(ListingController.showRoute)).put(isLoggedIn,isOwner,upload.single("lis") wrapAsync(ListingController.update)).delete(isOwner, ListingController.deleteRoute);
