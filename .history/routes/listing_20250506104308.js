...
router.route("/:id").get(wrapAsync(ListingController.showRoute)).put(isLoggedIn,isOwner wrapAsync(ListingController.update)).delete(isOwner, ListingController.deleteRoute);
